...
<footer class="border-t border-line px-5 pt-14 pb-10 lg:px-8 lg:pt-18">
    <div class="mx-auto max-w-page">
        ...
        <div class="flex flex-col gap-3 border-t border-line pt-8 text-[13px] text-ink-faint sm:flex-row sm:justify-between">
            ...
            {{-- Ссылка, а не текст (веха 4.17). До неё здесь стояла подпись
                 без адреса — заглушка вёрстки вехи 4.1, доставшаяся
                 из макета.

                 Подпись приведена к НАЗВАНИЮ ДОКУМЕНТА: «Политика
                 конфиденциальности» и «Политика обработки персональных
                 данных» — разные документы, и ссылка, обещающая одно,
                 а открывающая другое, — ровно та мелочь, к которой цепляются
                 при проверке.
