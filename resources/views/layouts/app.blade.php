...
<body class="min-h-screen antialiased">
    ...
    {{-- Подтверждение принятой заявки (веха 4.7). Стоит здесь, а не рядом
         с формой, и ровно один раз: форм на странице может оказаться две,
         а окно обязано быть одно. Связь идёт событием `lead-accepted`,
         причина — в шапке самого компонента. --}}
    <x-ui.modal />
