...
@section('content')
    ...
    --}}
    @if ($steps !== [])
        <section id="process" class="theme-light px-5 py-20 lg:px-8 lg:py-30">
            <div class="mx-auto max-w-page">
                <div class="mb-12 flex flex-col gap-5 lg:mb-14 lg:flex-row lg:items-end lg:justify-between lg:gap-12">
                    <div>
                ...
                <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
                    @foreach ($steps as $step)
                        <article class="overflow-hidden rounded-card border border-line bg-surface transition duration-250 hover:-translate-y-1 hover:border-accent/30">
