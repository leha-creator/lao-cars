...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->strictAuthorization()
            // Колокольчик уведомлений о новых заявках (веха 4.7). Читает
            // штатную таблицу `notifications`, привязанную к пользователю,
            // поэтому чужих уведомлений не показывает и политики не требует
            // — тот же случай, что и страница профиля выше.
            ->databaseNotifications()
            // Интервал назван явно, а не оставлен умолчанию: опрос стоит
            // запроса в базу на каждую открытую вкладку панели. При двух-трёх
            // сотрудниках это шум, при двадцати — повод перейти
            // на широковещательный канал, и величина платы должна быть
            // видна в коде, а не выясняться по графикам.
