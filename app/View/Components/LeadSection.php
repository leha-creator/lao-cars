 ...
 *
 * Именованный слот `below` принесла веха 4.6: контакты под текстом левой
 * колонки на главной. Слот, а не пятый скалярный параметр, потому что
 * содержимое — разметка (три подписанных значения), а компонент уже несёт
 * `eyebrow`, `heading`, `text` и `background`. Образец — `x-page-heading`,
 * куда веха 4.4 тем же способом добавила якорную навигацию.
 *
 * Слот выводится ТОЛЬКО в двухколоночной раскладке: левой колонки, под
 * которую он и заведён, в центрированном варианте не существует вовсе.
 */
