 ...
 *
 * **Подпись пункта каталога — «Автомобили», а название раздела осталось
 * «Каталог».** Расхождение намеренное: заказчик на демонстрации 11.08.2026
 * переименовал пункт меню, а не раздел. Поэтому заголовок страницы
 * `/catalog`, надзаголовок списка, хлебная крошка карточки авто и
 * микроразметка `CarStructuredData::breadcrumbs()` не тронуты — крошка
 * в разметке и крошка в JSON-LD обязаны совпадать, и правка одной из них
 * ломает пару. Выглядит это как забытое место; это не оно.
 */
