...
const fonts = [
    ...
    google('Unbounded', {
        ...
        //
        // `latin-ext` подключён ради одного символа — рубля ₽ (U+20BD).
        // В `latin` его нет (там евро, U+20AC), в `cyrillic` тоже нет, и
        // цена на всём сайте набиралась системным шрифтом ровно на этом
        // знаке: цифры одним шрифтом, значок другим. Подмножество весит
        // немного, но убирать его «ради веса шрифтов» нельзя — симптом
        // вернётся в том же виде и так же молча.
