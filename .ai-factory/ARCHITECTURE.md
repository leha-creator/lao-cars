...
│   └── seeders/
├── resources/
│   ├── images/                         # Статика вёрстки (логотип). Попадает
│   │                                   # в манифест через import.meta.glob
│   │                                   # в app.js — обязательно eager
...
│   │   ├── home/                       # index — до вехи 4.2 заглушка
│   │   ├── services/                   # index — до вехи 4.4 заглушка
│   │   ├── parts/                      # index — до вехи 4.4 заглушка
