 ...
 *
 * А вот `enableLeadForms()` нужен и без отправки: умолчание приёма заявок —
 * «выключено» (веха 4.17), и без включения страница отдаёт вместо формы
 * блок «приём приостановлен», то есть проверять здесь было бы нечего.
 */
